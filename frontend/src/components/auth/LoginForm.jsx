// Uncomment when you want to use OTP
...
// import VerifyOTPPopup from "@/components/auth/VerifyOTPPopup"; // ✅ Correct import
...
//   const [showVerifyOTP, setShowVerifyOTP] = useState(false); // ✅ Control OTP popup
...
//       setShowVerifyOTP(true); // ✅ Show OTP popup
...
//       <VerifyOTPPopup isOpen={showVerifyOTP} onClose={() => setShowVerifyOTP(false)} userId={userId} /> {/* ✅ Use OTP Popup */}
...
export function LoginForm() {
  ...
  const [showPassword, setShowPassword] = useState(false);
  const [loading, setLoading] = useState(false);
  // const [otpStep, setOtpStep] = useState(false); // ❌ Commented out OTP state
  // const [otpLoading, setOtpLoading] = useState(false); // ❌ Commented out OTP loading state
  // const [userId, setUserId] = useState(null); // ❌ Commented out userId state
  ...
  // ❌ Commented out OTP verification function
